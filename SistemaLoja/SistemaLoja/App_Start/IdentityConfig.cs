...
namespace SistemaLoja
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {            
            ...
            {
                Host = "smtp.live.com",
                DeliveryMethod = SmtpDeliveryMethod.Network, // metodo de envio de email
                UseDefaultCredentials = false, // usar credencial de forma padrão
                Port = 25,
                EnableSsl = true, // trabalhar com email tem que trabalha com ssl
